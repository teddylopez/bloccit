  ...
  describe 'GET #edit' do
    ...
    describe 'POST create' do
      it 'increased the number of Sponsored Post by 1' do
        expect { post :create, topic_id: topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph} }.to change(SponsoredPost, :count).by(1)
      end

      it 'assigns the new sponsored_post to @sponsored_post' do
        post :create, topic_id: topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph }
    ...
    describe 'PUT update' do
      it 'updates sponsored post with expected attributes' do
        ...
        put :update, topic_id: topic.id, id: sponsored_post.id, sponsored_post: { title: new_title, body: new_body }
